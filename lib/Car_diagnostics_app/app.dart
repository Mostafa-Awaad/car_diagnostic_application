    ...
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        colorScheme: const ColorScheme.dark(
          ...
          surface: Color(0xFF1B1B1F), // Background color for app screens
        ),
        ...
        elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            backgroundColor: const Color(0xFF29B6F6), // Neon blue background for buttons
            ...
            shadowColor: const Color(0xFF29B6F6).withOpacity(0.5), // Neon blue shadow for a glow effect
